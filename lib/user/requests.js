...

            {
                ...
                handler: function (email, password, callback) {
                    ...
                    sofaInternals.requests.user.findByEmail(email, function (err, userDocument) {
                        ...
                        if (err) {
                            return callback('findByEmail failed.', null);
                        ...
                        // Bcrypt.compare(password, userDocument.pw, function (err, res) {
                        ...
                        //         // console.log('valid pw received!!');
                        //         // console.log('password compare: ' + JSON.stringify(err) + JSON.stringify(res));
                        ...
                        //     // console.log('found email' + JSON.stringify(err) + JSON.stringify(userDocument));
                        //     // console.log('password compare: ' + JSON.stringify(err) + JSON.stringify(res));
...
internals.comparePassword =  function (submittedPassword, userDocument, callback) {
