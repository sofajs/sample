        ...
        .tools([
...

            {
                ...
                handler: function (usernameOriginal, usernameNew, callback) {
                    ...
                    originalTest = usernameOriginal.search(usernameKey);
                    newUsernameTest = usernameNew.search(usernameKey);
...

            {
                ...
                handler: function (emailOriginal, emailNew, callback) {
                    ...
                    originalTest = emailOriginal.search(emailKey);
                    newEmailTest = emailNew.search(emailKey);
